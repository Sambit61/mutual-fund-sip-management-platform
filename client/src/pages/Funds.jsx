    ...
    <div className="p-8 min-h-screen text-white max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
        ...
        {filteredFunds.map((fund) => (
          ...
          <div
            key={fund._id}
            className="bg-[var(--color-card-bg)] border border-gray-800 p-6 rounded-xl shadow-lg flex flex-col justify-between hover:border-brand transition group"
          >
