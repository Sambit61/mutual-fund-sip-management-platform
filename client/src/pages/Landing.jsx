    ...
    <div className="min-h-[calc(100vh-80px)] flex flex-col items-center justify-center text-center px-6 max-w-6xl mx-auto py-12">
      ...
      <div className="mb-16 max-w-3xl">
        ...
        <p className="text-lg text-gray-400 mb-10 max-w-2xl mx-auto">
          ...
          Automate your wealth creation with AI-driven insights.
          Manage your mutual funds, track market stocks in real-time,
          and execute smart SIPs seamlessly.
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full mt-12 text-left">
        ...
        <div className="bg-[var(--color-card-bg)] border border-gray-800 p-8 rounded-2xl shadow-lg relative overflow-hidden group">
          ...
          <p className="text-gray-400 text-sm">
            Monitor your portfolio and live market stocks with
            pinpoint accuracy and beautifully rendered charts.
          </p>
        ...
        <div className="bg-[var(--color-card-bg)] border border-gray-800 p-8 rounded-2xl shadow-lg relative overflow-hidden group">
          ...
          <p className="text-gray-400 text-sm">
            Set up algorithmic SIP contributions tailored to your
            risk profile and let the platform do the heavy lifting.
          </p>
        ...
        <div className="bg-[var(--color-card-bg)] border border-gray-800 p-8 rounded-2xl shadow-lg relative overflow-hidden group">
          ...
          <p className="text-gray-400 text-sm">
            Your data and transactions are secured using
            industry-leading encryption and standard
